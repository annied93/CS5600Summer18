...
- Did you collaborate with any other students/TAs/Professors?
	Nakul, Aayush (for piping help)
- Did you use any external resources? (Cite them below)
  - brennan.io
  - https://stackoverflow.com/questions/11927627/i-o-redirection-in-a-c-program
  - https://github.com/kalpishs/Unix-Shell-Implementation-in-C/blob/master/shell.c
  - Various StackOverflow posts on how to handle error
  - Piazza
- (Optional) What was your favorite part of the assignment?
	When things work out the way I want it to.
...
pwd gets the current working directory for the user, in this case it will obtain the directory
of the binary file currently executed - which is the Assignment4_Shell folder.

NOTES:

1) I use getenv() with "PWD" in order to obtain the enviroment directory
2) I then error check the execution to see if it's successful or not. If it's not, I print the 
error statement
3) If it is successfully executed, I will print the directory.
