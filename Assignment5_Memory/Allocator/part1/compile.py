...
#os.system('clang tests/t-test.c -o tests/t-test')
...
#os.system('clang -I. -o ./tests/t-test_mymalloc ./tests/t-test.c mymalloc.o')
os.system('clang -I. -o ./tests/test4_mymalloc ./tests/ttest.c mymalloc.o')
