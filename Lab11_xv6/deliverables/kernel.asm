...
80102e22:	e8 d9 28 00 00       	call   80105700 <idtinit>
...
80102eae:	e8 0d 08 00 00       	call   801036c0 <pinit>
  tvinit();        // trap vectors
80102eb3:	e8 a8 27 00 00       	call   80105660 <tvinit>
  binit();         // buffer cache
...
80103624:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103627:	c7 40 14 52 56 10 80 	movl   $0x80105652,0x14(%eax)
...
8010374a:	68 30 75 10 80       	push   $0x80107530
...
80103ecc:	e8 0f 05 00 00       	call   801043e0 <release>
      return -1;
...
80103eef:	e8 cc 03 00 00       	call   801042c0 <acquire>
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f31:	e9 aa 04 00 00       	jmp    801043e0 <release>
...
80103f4f:	e8 6c 03 00 00       	call   801042c0 <acquire>
...
80103f84:	e8 57 04 00 00       	call   801043e0 <release>
      return 0;
...
80103fb0:	e8 2b 04 00 00       	call   801043e0 <release>
  return -1;
...
80104018:	8b 14 85 58 75 10 80 	mov    -0x7fef8aa8(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
...
80104096:	68 ed 74 10 80       	push   $0x801074ed
8010409b:	e8 c0 c5 ff ff       	call   80100660 <cprintf>
	return 22;
}
801040a0:	b8 16 00 00 00       	mov    $0x16,%eax
801040a5:	c9                   	leave  
801040a6:	c3                   	ret    
801040a7:	66 90                	xchg   %ax,%ax
...
801040ba:	68 70 75 10 80       	push   $0x80107570
...
80104363:	68 7b 75 10 80       	push   $0x8010757b
...
801043c5:	68 9a 75 10 80       	push   $0x8010759a
...
801043d2:	68 83 75 10 80       	push   $0x80107583
...
801043f1:	68 a1 75 10 80       	push   $0x801075a1
...
80104830 <syscall>:
[SYS_mike]    sys_mike, // functional pointer
};
...
80104870:	68 a9 75 10 80       	push   $0x801075a9
...
int sys_mike(void) {
	return mike();
80105484:	e9 07 ec ff ff       	jmp    80104090 <mike>
...
801054cc:	e8 6f f2 ff ff       	call   80104740 <argint>
...
8010551d:	e8 1e f2 ff ff       	call   80104740 <argint>
...
8010556d:	e8 ce f1 ff ff       	call   80104740 <argint>
...
80105585:	e8 36 ed ff ff       	call   801042c0 <acquire>
  ticks0 = ticks;
...
801055d5:	e8 06 ee ff ff       	call   801043e0 <release>
      return -1;
...
801055f8:	e8 e3 ed ff ff       	call   801043e0 <release>
  return 0;
...
80105649:	54                   	push   %esp
  call trap
8010564a:	e8 e1 00 00 00       	call   80105730 <trap>
  addl $4, %esp
...
80105674:	c6 04 c5 a4 4c 11 80 	movb   $0x0,-0x7feeb35c(,%eax,8)
8010567b:	00 
8010567c:	66 89 0c c5 a2 4c 11 	mov    %cx,-0x7feeb35e(,%eax,8)
80105683:	80 
80105684:	c6 04 c5 a5 4c 11 80 	movb   $0x8e,-0x7feeb35b(,%eax,8)
8010568b:	8e 
8010568c:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105693:	80 
80105694:	c1 ea 10             	shr    $0x10,%edx
80105697:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
8010569e:	80 
void
tvinit(void)
{
...
801056b9:	68 9d 76 10 80       	push   $0x8010769d
801056be:	68 60 4c 11 80       	push   $0x80114c60
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056c3:	66 89 15 a2 4e 11 80 	mov    %dx,0x80114ea2
801056ca:	c6 05 a4 4e 11 80 00 	movb   $0x0,0x80114ea4
801056d1:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
801056d7:	c1 e8 10             	shr    $0x10,%eax
801056da:	c6 05 a5 4e 11 80 ef 	movb   $0xef,0x80114ea5
801056e1:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6

  initlock(&tickslock, "time");
801056e7:	e8 d4 ea ff ff       	call   801041c0 <initlock>
}
801056ec:	83 c4 10             	add    $0x10,%esp
801056ef:	c9                   	leave  
801056f0:	c3                   	ret    
801056f1:	eb 0d                	jmp    80105700 <idtinit>
801056f3:	90                   	nop
801056f4:	90                   	nop
801056f5:	90                   	nop
801056f6:	90                   	nop
...
80105742:	0f 84 88 01 00 00    	je     801058d0 <trap+0x1a0>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105750:	ff 24 85 44 77 10 80 	jmp    *-0x7fef88bc(,%eax,4)
...
80105760:	e8 1b e0 ff ff       	call   80103780 <myproc>
80105765:	85 c0                	test   %eax,%eax
80105767:	0f 84 d7 01 00 00    	je     80105944 <trap+0x214>
8010576d:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105771:	0f 84 cd 01 00 00    	je     80105944 <trap+0x214>
...
8010577a:	8b 57 38             	mov    0x38(%edi),%edx
8010577d:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105780:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105783:	e8 d8 df ff ff       	call   80103760 <cpuid>
80105788:	8b 77 34             	mov    0x34(%edi),%esi
8010578b:	8b 5f 30             	mov    0x30(%edi),%ebx
8010578e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105791:	e8 ea df ff ff       	call   80103780 <myproc>
...
801057a5:	52                   	push   %edx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801057a6:	8b 55 e0             	mov    -0x20(%ebp),%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801057a9:	ff 75 e4             	pushl  -0x1c(%ebp)
...
801057b5:	68 00 77 10 80       	push   $0x80107700
...
801057c2:	e8 b9 df ff ff       	call   80103780 <myproc>
...
801057d7:	74 0c                	je     801057e5 <trap+0xb5>
801057d9:	e8 a2 df ff ff       	call   80103780 <myproc>
801057de:	8b 50 24             	mov    0x24(%eax),%edx
801057e1:	85 d2                	test   %edx,%edx
801057e3:	75 4b                	jne    80105830 <trap+0x100>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801057e5:	e8 96 df ff ff       	call   80103780 <myproc>
801057ea:	85 c0                	test   %eax,%eax
801057ec:	74 0b                	je     801057f9 <trap+0xc9>
801057ee:	e8 8d df ff ff       	call   80103780 <myproc>
801057f3:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801057f7:	74 4f                	je     80105848 <trap+0x118>
...
80105800:	74 1d                	je     8010581f <trap+0xef>
80105802:	e8 79 df ff ff       	call   80103780 <myproc>
80105807:	8b 40 24             	mov    0x24(%eax),%eax
8010580a:	85 c0                	test   %eax,%eax
8010580c:	74 11                	je     8010581f <trap+0xef>
8010580e:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105812:	83 e0 03             	and    $0x3,%eax
80105815:	66 83 f8 03          	cmp    $0x3,%ax
80105819:	0f 84 da 00 00 00    	je     801058f9 <trap+0x1c9>
    exit();
}
...
80105829:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  // until it gets to the regular system call return.)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105830:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105834:	83 e0 03             	and    $0x3,%eax
80105837:	66 83 f8 03          	cmp    $0x3,%ax
8010583b:	75 a8                	jne    801057e5 <trap+0xb5>
    exit();
8010583d:	e8 6e e3 ff ff       	call   80103bb0 <exit>
80105842:	eb a1                	jmp    801057e5 <trap+0xb5>
80105844:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105848:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
8010584c:	75 ab                	jne    801057f9 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
8010584e:	e8 8d e4 ff ff       	call   80103ce0 <yield>
80105853:	eb a4                	jmp    801057f9 <trap+0xc9>
80105855:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105858:	e8 03 df ff ff       	call   80103760 <cpuid>
8010585d:	85 c0                	test   %eax,%eax
8010585f:	0f 84 ab 00 00 00    	je     80105910 <trap+0x1e0>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
...
80105865:	e8 a6 ce ff ff       	call   80102710 <lapiceoi>
    break;
8010586a:	e9 61 ff ff ff       	jmp    801057d0 <trap+0xa0>
8010586f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105870:	e8 5b cd ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
80105875:	e8 96 ce ff ff       	call   80102710 <lapiceoi>
    break;
8010587a:	e9 51 ff ff ff       	jmp    801057d0 <trap+0xa0>
8010587f:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105880:	e8 5b 02 00 00       	call   80105ae0 <uartintr>
    lapiceoi();
80105885:	e8 86 ce ff ff       	call   80102710 <lapiceoi>
    break;
8010588a:	e9 41 ff ff ff       	jmp    801057d0 <trap+0xa0>
8010588f:	90                   	nop
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105890:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80105894:	8b 77 38             	mov    0x38(%edi),%esi
80105897:	e8 c4 de ff ff       	call   80103760 <cpuid>
8010589c:	56                   	push   %esi
8010589d:	53                   	push   %ebx
8010589e:	50                   	push   %eax
8010589f:	68 a8 76 10 80       	push   $0x801076a8
801058a4:	e8 b7 ad ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
801058a9:	e8 62 ce ff ff       	call   80102710 <lapiceoi>
    break;
801058ae:	83 c4 10             	add    $0x10,%esp
801058b1:	e9 1a ff ff ff       	jmp    801057d0 <trap+0xa0>
...
801058b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801058c0:	e8 8b c7 ff ff       	call   80102050 <ideintr>
801058c5:	eb 9e                	jmp    80105865 <trap+0x135>
...
801058d5:	8b 58 24             	mov    0x24(%eax),%ebx
801058d8:	85 db                	test   %ebx,%ebx
801058da:	75 2c                	jne    80105908 <trap+0x1d8>
      exit();
    myproc()->tf = tf;
801058dc:	e8 9f de ff ff       	call   80103780 <myproc>
801058e1:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801058e4:	e8 47 ef ff ff       	call   80104830 <syscall>
    if(myproc()->killed)
801058e9:	e8 92 de ff ff       	call   80103780 <myproc>
801058ee:	8b 48 24             	mov    0x24(%eax),%ecx
801058f1:	85 c9                	test   %ecx,%ecx
801058f3:	0f 84 26 ff ff ff    	je     8010581f <trap+0xef>
    yield();
...
801058ff:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105900:	e9 ab e2 ff ff       	jmp    80103bb0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105908:	e8 a3 e2 ff ff       	call   80103bb0 <exit>
8010590d:	eb cd                	jmp    801058dc <trap+0x1ac>
8010590f:	90                   	nop
  }
...
80105918:	e8 a3 e9 ff ff       	call   801042c0 <acquire>
      ticks++;
      wakeup(&ticks);
...
80105937:	e8 a4 ea ff ff       	call   801043e0 <release>
8010593c:	83 c4 10             	add    $0x10,%esp
8010593f:	e9 21 ff ff ff       	jmp    80105865 <trap+0x135>
...
80105958:	68 cc 76 10 80       	push   $0x801076cc
8010595d:	e8 fe ac ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105962:	83 c4 14             	add    $0x14,%esp
80105965:	68 a2 76 10 80       	push   $0x801076a2
...
80105a5f:	bb c4 77 10 80       	mov    $0x801077c4,%ebx
...
80105af7:	6a 00                	push   $0x0
  jmp alltraps
80105af9:	e9 3c fb ff ff       	jmp    8010563a <alltraps>
...
80105b00:	6a 01                	push   $0x1
  jmp alltraps
80105b02:	e9 33 fb ff ff       	jmp    8010563a <alltraps>
...
80105b09:	6a 02                	push   $0x2
  jmp alltraps
80105b0b:	e9 2a fb ff ff       	jmp    8010563a <alltraps>
...
80105b12:	6a 03                	push   $0x3
  jmp alltraps
80105b14:	e9 21 fb ff ff       	jmp    8010563a <alltraps>
...
80105b1b:	6a 04                	push   $0x4
  jmp alltraps
80105b1d:	e9 18 fb ff ff       	jmp    8010563a <alltraps>
...
80105b24:	6a 05                	push   $0x5
  jmp alltraps
80105b26:	e9 0f fb ff ff       	jmp    8010563a <alltraps>
...
80105b2d:	6a 06                	push   $0x6
  jmp alltraps
80105b2f:	e9 06 fb ff ff       	jmp    8010563a <alltraps>
...
80105b36:	6a 07                	push   $0x7
  jmp alltraps
80105b38:	e9 fd fa ff ff       	jmp    8010563a <alltraps>
...
80105b3d:	6a 08                	push   $0x8
  jmp alltraps
80105b3f:	e9 f6 fa ff ff       	jmp    8010563a <alltraps>
...
80105b46:	6a 09                	push   $0x9
  jmp alltraps
80105b48:	e9 ed fa ff ff       	jmp    8010563a <alltraps>
...
80105b54:	6a 0b                	push   $0xb
  jmp alltraps
80105b56:	e9 df fa ff ff       	jmp    8010563a <alltraps>
...
80105b5b:	6a 0c                	push   $0xc
  jmp alltraps
80105b5d:	e9 d8 fa ff ff       	jmp    8010563a <alltraps>
...
80105b62:	6a 0d                	push   $0xd
  jmp alltraps
80105b64:	e9 d1 fa ff ff       	jmp    8010563a <alltraps>
...
80105b69:	6a 0e                	push   $0xe
  jmp alltraps
80105b6b:	e9 ca fa ff ff       	jmp    8010563a <alltraps>
...
80105b72:	6a 0f                	push   $0xf
  jmp alltraps
80105b74:	e9 c1 fa ff ff       	jmp    8010563a <alltraps>
...
80105b8b:	6a 12                	push   $0x12
  jmp alltraps
80105b8d:	e9 a8 fa ff ff       	jmp    8010563a <alltraps>
...
80105b94:	6a 13                	push   $0x13
  jmp alltraps
80105b96:	e9 9f fa ff ff       	jmp    8010563a <alltraps>
...
80105b9d:	6a 14                	push   $0x14
  jmp alltraps
80105b9f:	e9 96 fa ff ff       	jmp    8010563a <alltraps>
...
80105ba6:	6a 15                	push   $0x15
  jmp alltraps
80105ba8:	e9 8d fa ff ff       	jmp    8010563a <alltraps>
...
80105baf:	6a 16                	push   $0x16
  jmp alltraps
80105bb1:	e9 84 fa ff ff       	jmp    8010563a <alltraps>
...
80105bb8:	6a 17                	push   $0x17
  jmp alltraps
80105bba:	e9 7b fa ff ff       	jmp    8010563a <alltraps>
...
80105bc1:	6a 18                	push   $0x18
  jmp alltraps
80105bc3:	e9 72 fa ff ff       	jmp    8010563a <alltraps>
...
80105bca:	6a 19                	push   $0x19
  jmp alltraps
80105bcc:	e9 69 fa ff ff       	jmp    8010563a <alltraps>
...
80105bd3:	6a 1a                	push   $0x1a
  jmp alltraps
80105bd5:	e9 60 fa ff ff       	jmp    8010563a <alltraps>
...
80105bdc:	6a 1b                	push   $0x1b
  jmp alltraps
80105bde:	e9 57 fa ff ff       	jmp    8010563a <alltraps>
...
80105be5:	6a 1c                	push   $0x1c
  jmp alltraps
80105be7:	e9 4e fa ff ff       	jmp    8010563a <alltraps>
...
80105bee:	6a 1d                	push   $0x1d
  jmp alltraps
80105bf0:	e9 45 fa ff ff       	jmp    8010563a <alltraps>
...
80105bf7:	6a 1e                	push   $0x1e
  jmp alltraps
80105bf9:	e9 3c fa ff ff       	jmp    8010563a <alltraps>
...
80105c00:	6a 1f                	push   $0x1f
  jmp alltraps
80105c02:	e9 33 fa ff ff       	jmp    8010563a <alltraps>
...
80105c09:	6a 20                	push   $0x20
  jmp alltraps
80105c0b:	e9 2a fa ff ff       	jmp    8010563a <alltraps>
...
80105c12:	6a 21                	push   $0x21
  jmp alltraps
80105c14:	e9 21 fa ff ff       	jmp    8010563a <alltraps>
...
80105c1b:	6a 22                	push   $0x22
  jmp alltraps
80105c1d:	e9 18 fa ff ff       	jmp    8010563a <alltraps>
...
80105c24:	6a 23                	push   $0x23
  jmp alltraps
80105c26:	e9 0f fa ff ff       	jmp    8010563a <alltraps>
...
80105c2d:	6a 24                	push   $0x24
  jmp alltraps
80105c2f:	e9 06 fa ff ff       	jmp    8010563a <alltraps>
...
80105c36:	6a 25                	push   $0x25
  jmp alltraps
80105c38:	e9 fd f9 ff ff       	jmp    8010563a <alltraps>
...
80105c3f:	6a 26                	push   $0x26
  jmp alltraps
80105c41:	e9 f4 f9 ff ff       	jmp    8010563a <alltraps>
...
80105c48:	6a 27                	push   $0x27
  jmp alltraps
80105c4a:	e9 eb f9 ff ff       	jmp    8010563a <alltraps>
...
80105c51:	6a 28                	push   $0x28
  jmp alltraps
80105c53:	e9 e2 f9 ff ff       	jmp    8010563a <alltraps>
...
80105c5a:	6a 29                	push   $0x29
  jmp alltraps
80105c5c:	e9 d9 f9 ff ff       	jmp    8010563a <alltraps>
...
80105c63:	6a 2a                	push   $0x2a
  jmp alltraps
80105c65:	e9 d0 f9 ff ff       	jmp    8010563a <alltraps>
...
80105c6c:	6a 2b                	push   $0x2b
  jmp alltraps
80105c6e:	e9 c7 f9 ff ff       	jmp    8010563a <alltraps>
...
80105c75:	6a 2c                	push   $0x2c
  jmp alltraps
80105c77:	e9 be f9 ff ff       	jmp    8010563a <alltraps>
...
80105c7e:	6a 2d                	push   $0x2d
  jmp alltraps
80105c80:	e9 b5 f9 ff ff       	jmp    8010563a <alltraps>
...
80105c87:	6a 2e                	push   $0x2e
  jmp alltraps
80105c89:	e9 ac f9 ff ff       	jmp    8010563a <alltraps>
...
80105c90:	6a 2f                	push   $0x2f
  jmp alltraps
80105c92:	e9 a3 f9 ff ff       	jmp    8010563a <alltraps>
...
80105c99:	6a 30                	push   $0x30
  jmp alltraps
80105c9b:	e9 9a f9 ff ff       	jmp    8010563a <alltraps>
...
80105ca2:	6a 31                	push   $0x31
  jmp alltraps
80105ca4:	e9 91 f9 ff ff       	jmp    8010563a <alltraps>
...
80105cab:	6a 32                	push   $0x32
  jmp alltraps
80105cad:	e9 88 f9 ff ff       	jmp    8010563a <alltraps>
...
80105cb4:	6a 33                	push   $0x33
  jmp alltraps
80105cb6:	e9 7f f9 ff ff       	jmp    8010563a <alltraps>
...
80105cbd:	6a 34                	push   $0x34
  jmp alltraps
80105cbf:	e9 76 f9 ff ff       	jmp    8010563a <alltraps>
...
80105cc6:	6a 35                	push   $0x35
  jmp alltraps
80105cc8:	e9 6d f9 ff ff       	jmp    8010563a <alltraps>
...
80105ccf:	6a 36                	push   $0x36
  jmp alltraps
80105cd1:	e9 64 f9 ff ff       	jmp    8010563a <alltraps>
...
80105cd8:	6a 37                	push   $0x37
  jmp alltraps
80105cda:	e9 5b f9 ff ff       	jmp    8010563a <alltraps>
...
80105ce1:	6a 38                	push   $0x38
  jmp alltraps
80105ce3:	e9 52 f9 ff ff       	jmp    8010563a <alltraps>
...
80105cea:	6a 39                	push   $0x39
  jmp alltraps
80105cec:	e9 49 f9 ff ff       	jmp    8010563a <alltraps>
...
80105cf3:	6a 3a                	push   $0x3a
  jmp alltraps
80105cf5:	e9 40 f9 ff ff       	jmp    8010563a <alltraps>
...
80105cfc:	6a 3b                	push   $0x3b
  jmp alltraps
80105cfe:	e9 37 f9 ff ff       	jmp    8010563a <alltraps>
...
80105d05:	6a 3c                	push   $0x3c
  jmp alltraps
80105d07:	e9 2e f9 ff ff       	jmp    8010563a <alltraps>
...
80105d0e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d10:	e9 25 f9 ff ff       	jmp    8010563a <alltraps>
...
80105d17:	6a 3e                	push   $0x3e
  jmp alltraps
80105d19:	e9 1c f9 ff ff       	jmp    8010563a <alltraps>
...
80105d20:	6a 3f                	push   $0x3f
  jmp alltraps
80105d22:	e9 13 f9 ff ff       	jmp    8010563a <alltraps>
...
80105d29:	6a 40                	push   $0x40
  jmp alltraps
80105d2b:	e9 0a f9 ff ff       	jmp    8010563a <alltraps>
...
80105d32:	6a 41                	push   $0x41
  jmp alltraps
80105d34:	e9 01 f9 ff ff       	jmp    8010563a <alltraps>
...
80105d3b:	6a 42                	push   $0x42
  jmp alltraps
80105d3d:	e9 f8 f8 ff ff       	jmp    8010563a <alltraps>
...
80105d44:	6a 43                	push   $0x43
  jmp alltraps
80105d46:	e9 ef f8 ff ff       	jmp    8010563a <alltraps>
...
80105d4d:	6a 44                	push   $0x44
  jmp alltraps
80105d4f:	e9 e6 f8 ff ff       	jmp    8010563a <alltraps>
...
80105d56:	6a 45                	push   $0x45
  jmp alltraps
80105d58:	e9 dd f8 ff ff       	jmp    8010563a <alltraps>
...
80105d5f:	6a 46                	push   $0x46
  jmp alltraps
80105d61:	e9 d4 f8 ff ff       	jmp    8010563a <alltraps>
...
80105d68:	6a 47                	push   $0x47
  jmp alltraps
80105d6a:	e9 cb f8 ff ff       	jmp    8010563a <alltraps>
...
80105d71:	6a 48                	push   $0x48
  jmp alltraps
80105d73:	e9 c2 f8 ff ff       	jmp    8010563a <alltraps>
...
80105d7a:	6a 49                	push   $0x49
  jmp alltraps
80105d7c:	e9 b9 f8 ff ff       	jmp    8010563a <alltraps>
...
80105d83:	6a 4a                	push   $0x4a
  jmp alltraps
80105d85:	e9 b0 f8 ff ff       	jmp    8010563a <alltraps>
...
80105d8c:	6a 4b                	push   $0x4b
  jmp alltraps
80105d8e:	e9 a7 f8 ff ff       	jmp    8010563a <alltraps>
...
80105d95:	6a 4c                	push   $0x4c
  jmp alltraps
80105d97:	e9 9e f8 ff ff       	jmp    8010563a <alltraps>
...
80105d9e:	6a 4d                	push   $0x4d
  jmp alltraps
80105da0:	e9 95 f8 ff ff       	jmp    8010563a <alltraps>
...
80105da7:	6a 4e                	push   $0x4e
  jmp alltraps
80105da9:	e9 8c f8 ff ff       	jmp    8010563a <alltraps>
...
80105db0:	6a 4f                	push   $0x4f
  jmp alltraps
80105db2:	e9 83 f8 ff ff       	jmp    8010563a <alltraps>
...
80105db9:	6a 50                	push   $0x50
  jmp alltraps
80105dbb:	e9 7a f8 ff ff       	jmp    8010563a <alltraps>
...
80105dc2:	6a 51                	push   $0x51
  jmp alltraps
80105dc4:	e9 71 f8 ff ff       	jmp    8010563a <alltraps>
...
80105dcb:	6a 52                	push   $0x52
  jmp alltraps
80105dcd:	e9 68 f8 ff ff       	jmp    8010563a <alltraps>
...
80105dd4:	6a 53                	push   $0x53
  jmp alltraps
80105dd6:	e9 5f f8 ff ff       	jmp    8010563a <alltraps>
...
80105ddd:	6a 54                	push   $0x54
  jmp alltraps
80105ddf:	e9 56 f8 ff ff       	jmp    8010563a <alltraps>
...
80105de6:	6a 55                	push   $0x55
  jmp alltraps
80105de8:	e9 4d f8 ff ff       	jmp    8010563a <alltraps>
...
80105def:	6a 56                	push   $0x56
  jmp alltraps
80105df1:	e9 44 f8 ff ff       	jmp    8010563a <alltraps>
...
80105df8:	6a 57                	push   $0x57
  jmp alltraps
80105dfa:	e9 3b f8 ff ff       	jmp    8010563a <alltraps>
...
80105e01:	6a 58                	push   $0x58
  jmp alltraps
80105e03:	e9 32 f8 ff ff       	jmp    8010563a <alltraps>
...
80105e0a:	6a 59                	push   $0x59
  jmp alltraps
80105e0c:	e9 29 f8 ff ff       	jmp    8010563a <alltraps>
...
80105e13:	6a 5a                	push   $0x5a
  jmp alltraps
80105e15:	e9 20 f8 ff ff       	jmp    8010563a <alltraps>
...
80105e1c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e1e:	e9 17 f8 ff ff       	jmp    8010563a <alltraps>
...
80105e25:	6a 5c                	push   $0x5c
  jmp alltraps
80105e27:	e9 0e f8 ff ff       	jmp    8010563a <alltraps>
...
80105e2e:	6a 5d                	push   $0x5d
  jmp alltraps
80105e30:	e9 05 f8 ff ff       	jmp    8010563a <alltraps>
...
80105e37:	6a 5e                	push   $0x5e
  jmp alltraps
80105e39:	e9 fc f7 ff ff       	jmp    8010563a <alltraps>
...
80105e40:	6a 5f                	push   $0x5f
  jmp alltraps
80105e42:	e9 f3 f7 ff ff       	jmp    8010563a <alltraps>
...
80105e49:	6a 60                	push   $0x60
  jmp alltraps
80105e4b:	e9 ea f7 ff ff       	jmp    8010563a <alltraps>
...
80105e52:	6a 61                	push   $0x61
  jmp alltraps
80105e54:	e9 e1 f7 ff ff       	jmp    8010563a <alltraps>
...
80105e5b:	6a 62                	push   $0x62
  jmp alltraps
80105e5d:	e9 d8 f7 ff ff       	jmp    8010563a <alltraps>
...
80105e64:	6a 63                	push   $0x63
  jmp alltraps
80105e66:	e9 cf f7 ff ff       	jmp    8010563a <alltraps>
...
80105e6d:	6a 64                	push   $0x64
  jmp alltraps
80105e6f:	e9 c6 f7 ff ff       	jmp    8010563a <alltraps>
...
80105e76:	6a 65                	push   $0x65
  jmp alltraps
80105e78:	e9 bd f7 ff ff       	jmp    8010563a <alltraps>
...
80105e7f:	6a 66                	push   $0x66
  jmp alltraps
80105e81:	e9 b4 f7 ff ff       	jmp    8010563a <alltraps>
...
80105e88:	6a 67                	push   $0x67
  jmp alltraps
80105e8a:	e9 ab f7 ff ff       	jmp    8010563a <alltraps>
...
80105e91:	6a 68                	push   $0x68
  jmp alltraps
80105e93:	e9 a2 f7 ff ff       	jmp    8010563a <alltraps>
...
80105e9a:	6a 69                	push   $0x69
  jmp alltraps
80105e9c:	e9 99 f7 ff ff       	jmp    8010563a <alltraps>
...
80105ea3:	6a 6a                	push   $0x6a
  jmp alltraps
80105ea5:	e9 90 f7 ff ff       	jmp    8010563a <alltraps>
...
80105eac:	6a 6b                	push   $0x6b
  jmp alltraps
80105eae:	e9 87 f7 ff ff       	jmp    8010563a <alltraps>
...
80105eb5:	6a 6c                	push   $0x6c
  jmp alltraps
80105eb7:	e9 7e f7 ff ff       	jmp    8010563a <alltraps>
...
80105ebe:	6a 6d                	push   $0x6d
  jmp alltraps
80105ec0:	e9 75 f7 ff ff       	jmp    8010563a <alltraps>
...
80105ec7:	6a 6e                	push   $0x6e
  jmp alltraps
80105ec9:	e9 6c f7 ff ff       	jmp    8010563a <alltraps>
...
80105ed0:	6a 6f                	push   $0x6f
  jmp alltraps
80105ed2:	e9 63 f7 ff ff       	jmp    8010563a <alltraps>
...
80105ed9:	6a 70                	push   $0x70
  jmp alltraps
80105edb:	e9 5a f7 ff ff       	jmp    8010563a <alltraps>
...
80105ee2:	6a 71                	push   $0x71
  jmp alltraps
80105ee4:	e9 51 f7 ff ff       	jmp    8010563a <alltraps>
...
80105eeb:	6a 72                	push   $0x72
  jmp alltraps
80105eed:	e9 48 f7 ff ff       	jmp    8010563a <alltraps>
...
80105ef4:	6a 73                	push   $0x73
  jmp alltraps
80105ef6:	e9 3f f7 ff ff       	jmp    8010563a <alltraps>
...
80105efd:	6a 74                	push   $0x74
  jmp alltraps
80105eff:	e9 36 f7 ff ff       	jmp    8010563a <alltraps>
...
80105f06:	6a 75                	push   $0x75
  jmp alltraps
80105f08:	e9 2d f7 ff ff       	jmp    8010563a <alltraps>
...
80105f0f:	6a 76                	push   $0x76
  jmp alltraps
80105f11:	e9 24 f7 ff ff       	jmp    8010563a <alltraps>
...
80105f18:	6a 77                	push   $0x77
  jmp alltraps
80105f1a:	e9 1b f7 ff ff       	jmp    8010563a <alltraps>
...
80105f21:	6a 78                	push   $0x78
  jmp alltraps
80105f23:	e9 12 f7 ff ff       	jmp    8010563a <alltraps>
...
80105f2a:	6a 79                	push   $0x79
  jmp alltraps
80105f2c:	e9 09 f7 ff ff       	jmp    8010563a <alltraps>
...
80105f33:	6a 7a                	push   $0x7a
  jmp alltraps
80105f35:	e9 00 f7 ff ff       	jmp    8010563a <alltraps>
...
80105f3c:	6a 7b                	push   $0x7b
  jmp alltraps
80105f3e:	e9 f7 f6 ff ff       	jmp    8010563a <alltraps>
...
80105f45:	6a 7c                	push   $0x7c
  jmp alltraps
80105f47:	e9 ee f6 ff ff       	jmp    8010563a <alltraps>
...
80105f4e:	6a 7d                	push   $0x7d
  jmp alltraps
80105f50:	e9 e5 f6 ff ff       	jmp    8010563a <alltraps>
...
80105f57:	6a 7e                	push   $0x7e
  jmp alltraps
80105f59:	e9 dc f6 ff ff       	jmp    8010563a <alltraps>
...
80105f60:	6a 7f                	push   $0x7f
  jmp alltraps
80105f62:	e9 d3 f6 ff ff       	jmp    8010563a <alltraps>
...
80105f69:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105f6e:	e9 c7 f6 ff ff       	jmp    8010563a <alltraps>
...
80105f75:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105f7a:	e9 bb f6 ff ff       	jmp    8010563a <alltraps>
...
80105f81:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105f86:	e9 af f6 ff ff       	jmp    8010563a <alltraps>
...
80105f8d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105f92:	e9 a3 f6 ff ff       	jmp    8010563a <alltraps>
...
80105f99:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105f9e:	e9 97 f6 ff ff       	jmp    8010563a <alltraps>
...
80105fa5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105faa:	e9 8b f6 ff ff       	jmp    8010563a <alltraps>
...
80105fb1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105fb6:	e9 7f f6 ff ff       	jmp    8010563a <alltraps>
...
80105fbd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105fc2:	e9 73 f6 ff ff       	jmp    8010563a <alltraps>
...
80105fc9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105fce:	e9 67 f6 ff ff       	jmp    8010563a <alltraps>
...
80105fd5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105fda:	e9 5b f6 ff ff       	jmp    8010563a <alltraps>
...
80105fe1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105fe6:	e9 4f f6 ff ff       	jmp    8010563a <alltraps>
...
80105fed:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105ff2:	e9 43 f6 ff ff       	jmp    8010563a <alltraps>
...
80105ff9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105ffe:	e9 37 f6 ff ff       	jmp    8010563a <alltraps>
...
80106005:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010600a:	e9 2b f6 ff ff       	jmp    8010563a <alltraps>
...
80106011:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106016:	e9 1f f6 ff ff       	jmp    8010563a <alltraps>
...
8010601d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106022:	e9 13 f6 ff ff       	jmp    8010563a <alltraps>
...
80106029:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010602e:	e9 07 f6 ff ff       	jmp    8010563a <alltraps>
...
80106035:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010603a:	e9 fb f5 ff ff       	jmp    8010563a <alltraps>
...
80106041:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106046:	e9 ef f5 ff ff       	jmp    8010563a <alltraps>
...
8010604d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106052:	e9 e3 f5 ff ff       	jmp    8010563a <alltraps>
...
80106059:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010605e:	e9 d7 f5 ff ff       	jmp    8010563a <alltraps>
...
80106065:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010606a:	e9 cb f5 ff ff       	jmp    8010563a <alltraps>
...
80106071:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106076:	e9 bf f5 ff ff       	jmp    8010563a <alltraps>
...
8010607d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106082:	e9 b3 f5 ff ff       	jmp    8010563a <alltraps>
...
80106089:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010608e:	e9 a7 f5 ff ff       	jmp    8010563a <alltraps>
...
80106095:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010609a:	e9 9b f5 ff ff       	jmp    8010563a <alltraps>
...
801060a1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801060a6:	e9 8f f5 ff ff       	jmp    8010563a <alltraps>
...
801060ad:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801060b2:	e9 83 f5 ff ff       	jmp    8010563a <alltraps>
...
801060b9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801060be:	e9 77 f5 ff ff       	jmp    8010563a <alltraps>
...
801060c5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801060ca:	e9 6b f5 ff ff       	jmp    8010563a <alltraps>
...
801060d1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801060d6:	e9 5f f5 ff ff       	jmp    8010563a <alltraps>
...
801060dd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801060e2:	e9 53 f5 ff ff       	jmp    8010563a <alltraps>
...
801060e9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801060ee:	e9 47 f5 ff ff       	jmp    8010563a <alltraps>
...
801060f5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801060fa:	e9 3b f5 ff ff       	jmp    8010563a <alltraps>
...
80106101:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106106:	e9 2f f5 ff ff       	jmp    8010563a <alltraps>
...
8010610d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106112:	e9 23 f5 ff ff       	jmp    8010563a <alltraps>
...
80106119:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010611e:	e9 17 f5 ff ff       	jmp    8010563a <alltraps>
...
80106125:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010612a:	e9 0b f5 ff ff       	jmp    8010563a <alltraps>
...
80106131:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106136:	e9 ff f4 ff ff       	jmp    8010563a <alltraps>
...
8010613d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106142:	e9 f3 f4 ff ff       	jmp    8010563a <alltraps>
...
80106149:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010614e:	e9 e7 f4 ff ff       	jmp    8010563a <alltraps>
...
80106155:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010615a:	e9 db f4 ff ff       	jmp    8010563a <alltraps>
...
80106161:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106166:	e9 cf f4 ff ff       	jmp    8010563a <alltraps>
...
8010616d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106172:	e9 c3 f4 ff ff       	jmp    8010563a <alltraps>
...
80106179:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010617e:	e9 b7 f4 ff ff       	jmp    8010563a <alltraps>
...
80106185:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010618a:	e9 ab f4 ff ff       	jmp    8010563a <alltraps>
...
80106191:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106196:	e9 9f f4 ff ff       	jmp    8010563a <alltraps>
...
8010619d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801061a2:	e9 93 f4 ff ff       	jmp    8010563a <alltraps>
...
801061a9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801061ae:	e9 87 f4 ff ff       	jmp    8010563a <alltraps>
...
801061b5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801061ba:	e9 7b f4 ff ff       	jmp    8010563a <alltraps>
...
801061c1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801061c6:	e9 6f f4 ff ff       	jmp    8010563a <alltraps>
...
801061cd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801061d2:	e9 63 f4 ff ff       	jmp    8010563a <alltraps>
...
801061d9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801061de:	e9 57 f4 ff ff       	jmp    8010563a <alltraps>
...
801061e5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801061ea:	e9 4b f4 ff ff       	jmp    8010563a <alltraps>
...
801061f1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801061f6:	e9 3f f4 ff ff       	jmp    8010563a <alltraps>
...
801061fd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106202:	e9 33 f4 ff ff       	jmp    8010563a <alltraps>
...
80106209:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010620e:	e9 27 f4 ff ff       	jmp    8010563a <alltraps>
...
80106215:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010621a:	e9 1b f4 ff ff       	jmp    8010563a <alltraps>
...
80106221:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106226:	e9 0f f4 ff ff       	jmp    8010563a <alltraps>
...
8010622d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106232:	e9 03 f4 ff ff       	jmp    8010563a <alltraps>
...
80106239:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010623e:	e9 f7 f3 ff ff       	jmp    8010563a <alltraps>
...
80106245:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010624a:	e9 eb f3 ff ff       	jmp    8010563a <alltraps>
...
80106251:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106256:	e9 df f3 ff ff       	jmp    8010563a <alltraps>
...
8010625d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106262:	e9 d3 f3 ff ff       	jmp    8010563a <alltraps>
...
80106269:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010626e:	e9 c7 f3 ff ff       	jmp    8010563a <alltraps>
...
80106275:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010627a:	e9 bb f3 ff ff       	jmp    8010563a <alltraps>
...
80106281:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106286:	e9 af f3 ff ff       	jmp    8010563a <alltraps>
...
8010628d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106292:	e9 a3 f3 ff ff       	jmp    8010563a <alltraps>
...
80106299:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010629e:	e9 97 f3 ff ff       	jmp    8010563a <alltraps>
...
801062a5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801062aa:	e9 8b f3 ff ff       	jmp    8010563a <alltraps>
...
801062b1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801062b6:	e9 7f f3 ff ff       	jmp    8010563a <alltraps>
...
801062bd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801062c2:	e9 73 f3 ff ff       	jmp    8010563a <alltraps>
...
801062c9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801062ce:	e9 67 f3 ff ff       	jmp    8010563a <alltraps>
...
801062d5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801062da:	e9 5b f3 ff ff       	jmp    8010563a <alltraps>
...
801062e1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801062e6:	e9 4f f3 ff ff       	jmp    8010563a <alltraps>
...
801062ed:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801062f2:	e9 43 f3 ff ff       	jmp    8010563a <alltraps>
...
801062f9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801062fe:	e9 37 f3 ff ff       	jmp    8010563a <alltraps>
...
80106305:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010630a:	e9 2b f3 ff ff       	jmp    8010563a <alltraps>
...
80106311:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106316:	e9 1f f3 ff ff       	jmp    8010563a <alltraps>
...
8010631d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106322:	e9 13 f3 ff ff       	jmp    8010563a <alltraps>
...
80106329:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010632e:	e9 07 f3 ff ff       	jmp    8010563a <alltraps>
...
80106335:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010633a:	e9 fb f2 ff ff       	jmp    8010563a <alltraps>
...
80106341:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106346:	e9 ef f2 ff ff       	jmp    8010563a <alltraps>
...
8010634d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106352:	e9 e3 f2 ff ff       	jmp    8010563a <alltraps>
...
80106359:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010635e:	e9 d7 f2 ff ff       	jmp    8010563a <alltraps>
...
80106365:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010636a:	e9 cb f2 ff ff       	jmp    8010563a <alltraps>
...
80106371:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106376:	e9 bf f2 ff ff       	jmp    8010563a <alltraps>
...
8010637d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106382:	e9 b3 f2 ff ff       	jmp    8010563a <alltraps>
...
80106389:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010638e:	e9 a7 f2 ff ff       	jmp    8010563a <alltraps>
...
80106395:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010639a:	e9 9b f2 ff ff       	jmp    8010563a <alltraps>
...
801063a1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801063a6:	e9 8f f2 ff ff       	jmp    8010563a <alltraps>
...
801063ad:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801063b2:	e9 83 f2 ff ff       	jmp    8010563a <alltraps>
...
801063b9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801063be:	e9 77 f2 ff ff       	jmp    8010563a <alltraps>
...
801063c5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801063ca:	e9 6b f2 ff ff       	jmp    8010563a <alltraps>
...
801063d1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801063d6:	e9 5f f2 ff ff       	jmp    8010563a <alltraps>
...
801063dd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801063e2:	e9 53 f2 ff ff       	jmp    8010563a <alltraps>
...
801063e9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801063ee:	e9 47 f2 ff ff       	jmp    8010563a <alltraps>
...
801063f5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801063fa:	e9 3b f2 ff ff       	jmp    8010563a <alltraps>
...
80106401:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106406:	e9 2f f2 ff ff       	jmp    8010563a <alltraps>
...
8010640d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106412:	e9 23 f2 ff ff       	jmp    8010563a <alltraps>
...
80106419:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010641e:	e9 17 f2 ff ff       	jmp    8010563a <alltraps>
...
80106425:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010642a:	e9 0b f2 ff ff       	jmp    8010563a <alltraps>
...
80106431:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106436:	e9 ff f1 ff ff       	jmp    8010563a <alltraps>
...
8010643d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106442:	e9 f3 f1 ff ff       	jmp    8010563a <alltraps>
...
80106449:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010644e:	e9 e7 f1 ff ff       	jmp    8010563a <alltraps>
...
80106455:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010645a:	e9 db f1 ff ff       	jmp    8010563a <alltraps>
...
80106461:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106466:	e9 cf f1 ff ff       	jmp    8010563a <alltraps>
...
8010646d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106472:	e9 c3 f1 ff ff       	jmp    8010563a <alltraps>
...
80106479:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010647e:	e9 b7 f1 ff ff       	jmp    8010563a <alltraps>
...
80106485:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010648a:	e9 ab f1 ff ff       	jmp    8010563a <alltraps>
...
80106491:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106496:	e9 9f f1 ff ff       	jmp    8010563a <alltraps>
...
8010649d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801064a2:	e9 93 f1 ff ff       	jmp    8010563a <alltraps>
...
801064a9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801064ae:	e9 87 f1 ff ff       	jmp    8010563a <alltraps>
...
801064b5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801064ba:	e9 7b f1 ff ff       	jmp    8010563a <alltraps>
...
801064c1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801064c6:	e9 6f f1 ff ff       	jmp    8010563a <alltraps>
...
801064cd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801064d2:	e9 63 f1 ff ff       	jmp    8010563a <alltraps>
...
801064d9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801064de:	e9 57 f1 ff ff       	jmp    8010563a <alltraps>
...
801064e5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801064ea:	e9 4b f1 ff ff       	jmp    8010563a <alltraps>
...
801064f1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801064f6:	e9 3f f1 ff ff       	jmp    8010563a <alltraps>
...
801064fd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106502:	e9 33 f1 ff ff       	jmp    8010563a <alltraps>
...
80106509:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010650e:	e9 27 f1 ff ff       	jmp    8010563a <alltraps>
...
80106515:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010651a:	e9 1b f1 ff ff       	jmp    8010563a <alltraps>
...
80106521:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106526:	e9 0f f1 ff ff       	jmp    8010563a <alltraps>
...
8010652d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106532:	e9 03 f1 ff ff       	jmp    8010563a <alltraps>
...
80106539:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010653e:	e9 f7 f0 ff ff       	jmp    8010563a <alltraps>
...
80106545:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010654a:	e9 eb f0 ff ff       	jmp    8010563a <alltraps>
...
80106551:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106556:	e9 df f0 ff ff       	jmp    8010563a <alltraps>
...
8010655d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106562:	e9 d3 f0 ff ff       	jmp    8010563a <alltraps>
...
801065ca:	e8 61 de ff ff       	call   80104430 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010666d:	68 cc 77 10 80       	push   $0x801077cc
...
8010691b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010691c:	e9 4f da ff ff       	jmp    80104370 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106924:	68 d2 77 10 80       	push   $0x801077d2
...
80106931:	68 fd 77 10 80       	push   $0x801077fd
...
8010693e:	68 e8 77 10 80       	push   $0x801077e8
...
8010697f:	e8 ac da ff ff       	call   80104430 <memset>
...
801069b0:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
801069b1:	e9 2a db ff ff       	jmp    801044e0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
801069b9:	68 11 78 10 80       	push   $0x80107811
...
80106a6d:	68 2b 78 10 80       	push   $0x8010782b
...
80106a7a:	68 cc 78 10 80       	push   $0x801078cc
...
80106ad3:	e8 58 d9 ff ff       	call   80104430 <memset>
...
80106b11:	68 49 78 10 80       	push   $0x80107849
...
80106c2c:	68 7d 78 10 80       	push   $0x8010787d
...
80106c60:	e8 cb d7 ff ff       	call   80104430 <memset>
...
80106cff:	68 8e 78 10 80       	push   $0x8010788e
...
80106d50:	e8 8b d7 ff ff       	call   801044e0 <memmove>
...
80106de2:	68 b2 78 10 80       	push   $0x801078b2
...
80106def:	68 98 78 10 80       	push   $0x80107898
...
80106e7f:	e8 5c d6 ff ff       	call   801044e0 <memmove>
    len -= n;
    buf += n;
